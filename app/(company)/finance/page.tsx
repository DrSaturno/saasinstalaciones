...
import { FinancePendingPayments } from "@/components/company/finance-pending-payments";
...
export default async function FinancePage({
  ...
  return (
    <main className="mx-auto max-w-[1480px] space-y-6">
      ...
      <FinancePendingPayments rows={data.pendingPayments} totals={data.pendingPaymentTotals} />
